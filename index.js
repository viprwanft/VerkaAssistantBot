...
bot.on("message", async (msg) => {
  ...
  // In group chats: respond to ALL messages on first contact,
  // then only when mentioned or replied to (avoids flooding active chats)
  if (msg.chat.type !== "private") {
    ...
    // Respond if: first message from this user OR mentioned OR reply to bot
...
// Render requires an open port — this dummy server satisfies that requirement
